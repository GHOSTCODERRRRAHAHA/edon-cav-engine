...
| State | Description | Typical p_stress Range |
|-------|-------------|------------------------|
| `restorative` | Very low stress, optimal recovery | 0.0 - 0.20 |
| `balanced` | Normal operation, mild stress | 0.20 - 0.50 |
| `focus` | Medium stress, pushing but under control | 0.50 - 0.80 |
| `overload` | High stress, needs intervention | 0.80 - 1.0 |
