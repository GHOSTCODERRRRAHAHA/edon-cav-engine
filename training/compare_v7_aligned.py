"""
Compare EDON v7 (300 episodes, aligned reward) vs Baseline.

Loads results from:
- results/baseline_ep300_aligned.json
- results/edon_v7_ep300_aligned.json
...
def main():
    """Main comparison."""
    print("="*70)
    print("EDON v7 (300 episodes, aligned reward) vs Baseline Comparison")
    print("="*70)
    print()
    
    # Load results
    baseline_results = load_results("results/baseline_ep300_aligned.json")
    v7_results = load_results("results/edon_v7_ep300_aligned.json")
    ...
    if score_improved:
        ...
        print("   - Reward alignment improved (correlation: 0.446)")
        print("   - PPO updates more aggressive (clip fraction: 7-15%)")
        print("   - KL divergence active (policy changing)")
        print("   Possible next steps:")
        print("   - Train longer (500+ episodes)")
        print("   - Further improve reward alignment (target: >0.7 correlation)")
