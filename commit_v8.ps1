...
Write-Host "Staging EDON v8 files..." -ForegroundColor Cyan
...
git add results/edon_v8_memory_features.json 2>$null
git add results/edon_v8_generalization_test.json 2>$null

Write-Host "Committing..." -ForegroundColor Cyan
$commitMessage = @"
EDON v8: Temporal memory and predictive modulation for intervention minimization
