#!/usr/bin/env python3
"""
Demo Inference Example for EDON CAV v3.2 Model

Drop-in replacement that auto-loads feature order from schema JSON
and uses DataFrame to avoid warnings.
"""
...
# Map numeric class → label using schema mapping
